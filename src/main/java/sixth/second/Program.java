...
public class Program extends JFrame {
    ...
    public Program() {
        ...
        connectButton.addActionListener(e -> {
            ...
            Task ui = (Task) Proxy.newProxyInstance(getClass().getClassLoader(),
                    new Class[]{Task.class},
                    new CallHandler(new TaskImpl()));
            try {
                massage = new MSReceiver(InetAddress.getByName(addressTextField.getText()),
